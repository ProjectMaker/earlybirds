...
server.router = Object.assign({}, productsRoutes.paths)
...
server.httpServer = http.createServer((req, res) => {
    ...
    req.on('end', () => {
        ...
        let route = router.getRoute(trimmedPath, server.router)
        route = typeof(route) === 'object' ? route : { params: { }}
        let chosenHandler = typeof(server.router[route.path]) !== 'undefined' ? server.router[route.path] : handlers.notFound
